...
export const TransactionCard = ({ transaction, onDeleted, onEdit }: Props) => {
  ...
  return (
    <div className="group bg-white rounded-xl border border-gray-100 hover:border-gray-200 p-4 transition-all duration-200 hover:shadow-sm">
        ...
        <div className="flex flex-col items-end space-y-3">
          ...
          <div className="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            ...
            <button
              ...
              className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-red-600 bg-red-50 hover:bg-red-100 rounded-lg border border-red-200 transition-colors duration-200"
